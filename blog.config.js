...
const BLOG = {
  ...
  THEME: 'hexo-adswave', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Proxy302', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '专注海外动静态IP', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.proxy302.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Proxy302, 文章资讯', // 网站关键词 英文逗号隔开
  ...
  MERMAID_CDN:
    ...
    'https://cdn.jsdelivr.net/npm/mermaid@10.2.2/dist/mermaid.min.js', // CDN
